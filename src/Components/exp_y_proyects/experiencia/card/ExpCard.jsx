export default function ExpCard({ year, title, role, description, skills }) {
  return (
    <div className="w-full max-w-[750px] flex p-4 rounded-xl border border-transparent transition-all bg-gray-900 card-exp-container hover:border-[#8AEDC9] group">
      <div className="text-nowrap">
        <p className="text-[18px]">{year}</p>
      </div>

      <div className="flex flex-col items-start px-4">
        <h3 className="text-[15px] xl:text-[18px] font-bold text-white text-nowrap transition-all group-hover:text-[#8AEDC9]">{title}</h3>
